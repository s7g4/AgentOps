...
from app.providers.base import AnyResponseProvider, ResponseProvider
...
class ResponseGeneratorAgent:
    ...
    async def generate(
        ...
        return self.provider.generate(intent, tool_outputs, original_message)  # type: ignore[return-value]
